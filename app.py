...
guessPcs = tk.Label(window, text="Number of Guesses: 0", font=("Arial", 11))
...
def main():
    def new():
        ...
        guesspcsnumber = 0
        guessPcs.config(text="Number of Guesses: 0")
    ...
    def show():
        ...
        messagebox.showwarning("Alert","Answer Displayed in Shell")
    ...
    def guess():
        def go():
            ...
            guesspcsnumber += 1
            guessPcs.config(text="Number of Guesses: " + str(guesspcsnumber))

            if guessNumber == randomNumber:
                result.config(text="CORRECT GUESS!", fg="green", font=("Arial", 13))
                hint.config(text="")

                messagebox.showinfo("Correct", ("Number of Guesses: " + str(guesspcsnumber)))
